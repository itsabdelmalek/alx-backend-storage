...
class Cache:
    ...
    def get(
        ...
        """
        Retrieve data from Redis using the provided key and optional cfunc
        """
    ...
    def get_str(self, key: str) -> Optional[str]:
        """
        Automatically parametrize Cache.get with the correct conversion funct.
        """
...
def replay(func: Callable) -> None:
    ...
    inputs = [eval(args) for args in cache._redis.lrange(i_keys, 0, -1)]
    outputs = [eval(output) for output in cache._redis.lrange(o_keys, 0, -1)]
